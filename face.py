...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='../thermal_data', help="image path root")
    ...
    parser.add_argument('--txt_path', default='../thermal_data/testList.txt')
    args = parser.parse_args()

    # Initialize YOLOv8_face object detector
    YOLOv8_face_detector = YOLOv8_face(args.modelpath, conf_thres=args.confThreshold, iou_thres=args.nmsThreshold)
    
    lst = open_txt(args.txt_path)
    no_lst = []
    for p in tqdm(lst):
        img_path = os.path.join(args.root, "{}.jpg".format(p))
